...
sync func spawn_traffic_cones(tile, traffic_cone_rotation):
	var traffic_cone = preload("res://Props/TrafficCones/Cone.tscn").instance()
	traffic_cone.translation = Vector3((tile.x * 20) + 10, tile.y, (tile.z * 20) + 10)
	traffic_cone.rotation_degrees.y = traffic_cone_rotation
